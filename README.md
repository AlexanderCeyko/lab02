...
```bash
Username for 'https://github.com': AlexanderCeyko
Password for 'https://AlexanderCeyko@github.com': 
...
remote:      https://github.com/AlexanderCeyko/lab02/pull/new/patch1
remote: 
To https://github.com/AlexanderCeyko/lab02.git
...
```bash
Из https://github.com/AlexanderCeyko/lab02
...
```bash
Username for 'https://github.com': AlexandeCeyko
Password for 'https://AlexanderCeyko@github.com': 
